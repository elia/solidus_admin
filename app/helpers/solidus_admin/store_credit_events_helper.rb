...
#
# module SolidusAdmin::StoreCreditEventsHelper
...
#         solidus_admin.edit_user_path(originator),
#         options
#       )
#     when :line_item
...
#         solidus_admin.edit_order_path(order),
#         options
#       )
#     when :payment
...
#       link_to(
#         t(link_options[:translation_key], order_number: order.number, scope: 'spree'),
#         solidus_admin.order_payment_path(order, originator),
#         options
#       )
#     when :payments
...
#       link_to(
#         t(link_options[:translation_key], order_number: order.number, scope: 'spree'),
#         solidus_admin.order_payments_path(order),
#         options
#       )
#     end
#   end
...
# end
e = [
  "_store_credit.html.erb",
  "/Users/elia/Code/Nebulab/solidus_admin/app/views/solidus_admin/payments/source_forms/_store_credit.html.erb",
  "/Users/elia/Code/Nebulab/solidus_admin"
]


# #!/usr/bin/env ruby18 -wKU
# p [ENV['TM_FILENAME'], ENV['TM_FILEPATH'], ENV['TM_PROJECT_DIRECTORY'], ]
# extname = "_store_credit.html.erb".split('.', 2).last
# p extname
# puts "/Users/elia/Code/Nebulab/solidus_admin/app/views/solidus_admin/payments/source_forms/_store_credit.html.erb"["/Users/elia/Code/Nebulab/solidus_admin".size..extname.size].gsub(%{^app/}, '').tr('/', '.')
#!/usr/bin/env ruby18 -wKU
p [ENV['TM_FILENAME'], ENV['TM_FILEPATH'], ENV['TM_PROJECT_DIRECTORY'], ]
extname = '.'+ENV['TM_FILENAME'].split('.', 2).last
p ENV['TM_PROJECT_DIRECTORY'].size
p ENV['TM_FILEPATH'][0...-extname.size] #.gsub(%{^app/}, '').tr('/', '.')
