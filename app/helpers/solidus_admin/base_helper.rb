...
module SolidusAdmin
  module BaseHelper
    ...
    # @deprecated Render `solidus_admin/shared/preference_fields/\#{preference_type}' instead
    def preference_field_tag(name, value, options)
      type = options.delete(:type) || :text
      render "solidus_admin/shared/preference_fields/#{type}",
        name: name, value: value, html_options: options
    end
    deprecate preference_field_tag:
      "Render `solidus_admin/shared/preference_fields/\#{preference_type}' instead",
    ...
    #   <%= render "solidus_admin/shared/preference_fields/#{@object.preference_type(key)}",
    ...
    def preference_fields(object, form)
      ...
      capture do
        object.preferences.keys.each do |key|
          concat render("solidus_admin/shared/preference_fields/#{object.preference_type(key)}",
