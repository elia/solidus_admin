...
class SolidusAdmin::ResourceController < SolidusAdmin::BaseController
  ...
  def destroy
    ...
    if destroy_result
      ...
      respond_with(@object) do |format|
        ...
        format.js   { render partial: "solidus_admin/shared/destroy" }
      end
    else
  ...
  def load_resource
    if member_action?
      ...
      # call authorize! a third time (called twice already in SolidusAdmin::BaseController)
